...
$platformName = $oldInput['platform_name'] ?? ($socialMedia['platform_name'] ?? '');
$accountName = $oldInput['account_name'] ?? ($socialMedia['account_name'] ?? '');
$profileUrl = $oldInput['profile_url'] ?? ($socialMedia['profile_url'] ?? '');
$icon = $oldInput['icon'] ?? ($socialMedia['icon'] ?? '');
$isActive = $oldInput['is_active'] ?? ($socialMedia['is_active'] ?? 1);
?>
            ...
            <div class="col-sm-12">
              ...
              <div class="page-header-simple">
                <h3>
                  ...
                  <?php echo $isEdit ? 'Edit Social Media' : 'Tambah Social Media Baru'; ?>
                </h3>
              </div>
              ...
              <div class="container">
                ...
                <!-- Form -->
                <form method="POST" action="<?php echo $isEdit ? 'index.php?controller=socialMedia&action=update' : 'index.php?controller=socialMedia&action=store'; ?>"
                      id="socialMediaForm">

                  <?php if ($isEdit): ?>
                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($socialMedia['id']); ?>">
                  <?php endif; ?>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="input-group-wrapper">
                            ...
                            <input type="text"
                                   ...
                                   id="platform_name"
                                   name="platform_name"
                                   value="<?php echo htmlspecialchars($platformName); ?>"
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="input-group-wrapper">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Contoh: @username atau Page Name"
                                   required>
                            <div class="form-text">
                              <i class="fas fa-info-circle"></i>
                              Username atau nama halaman
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="form-section-body">
                      <div class="input-group-wrapper">
                        ...
                        <input type="url"
                               ...
                               id="profile_url"
                               name="profile_url"
                               value="<?php echo htmlspecialchars($profileUrl); ?>"
                               placeholder="Contoh: https://facebook.com/username"
                               required>
                        <div class="form-text">
                          <i class="fas fa-info-circle"></i>
                          URL lengkap menuju profil social media (https://...)
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="form-section-body">
                      ...
                      <div class="form-switch-wrapper">
                        <div class="form-switch-info">
                          ...
                          <p>Aktifkan social media ini agar ditampilkan di halaman depan</p>
                        </div>
                        <div>
                    ...
                    <div class="form-section-body">
                      <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-submit">
                          ...
                          <?php echo $isEdit ? 'Simpan Perubahan' : 'Simpan Social Media'; ?>
                        </button>
                      </div>
                    </div>
                  </div>
  ...
  <script>
    ...
    function confirmCancel() {
      SynAlert.confirm({
        ...
        onConfirm   : () => window.location.href = '<?= BASE_URL ?>/social-media'
      });
    }
    ...
    document.getElementById('socialMediaForm').addEventListener('submit', function(e) {
      ...
      // Reset validation
      [platformName, accountName, profileUrl].forEach(el => {
      ...
      if (!platformName.value.trim()) {
        platformName.classList.add('is-invalid');
        if (platformName.closest('.input-group-wrapper')) {
          platformName.closest('.input-group-wrapper').style.borderColor = '#dc2626';
        }
      ...
      if (!accountName.value.trim()) {
        ...
        if (accountName.closest('.input-group-wrapper')) {
          accountName.closest('.input-group-wrapper').style.borderColor = '#dc2626';
        }
      ...
      if (!profileUrl.value.trim()) {
        profileUrl.classList.add('is-invalid');
        if (profileUrl.closest('.input-group-wrapper')) {
          profileUrl.closest('.input-group-wrapper').style.borderColor = '#dc2626';
        }
        errors.push('URL profil wajib diisi');
        isValid = false;
      }
