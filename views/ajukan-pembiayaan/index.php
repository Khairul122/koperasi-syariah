...
<body class="with-welcome-text">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                  <div>
                    <h2 style="font-size: 28px; font-weight: 600; margin: 0 0 8px 0; color: white;">
                      <i class="fas fa-hand-holding-usd" style="margin-right: 10px;"></i>Pengajuan Pembiayaan Saya
                    </h2>
                  ...
                  <div style="display: flex; gap: 10px;">
                    <a href="index.php?controller=ajukanpembiayaan&action=create"
                      ...
                      <i class="fas fa-plus" style="margin-right: 8px;"></i>Ajukan Pembiayaan Baru
                    </a>
                  </div>
                </div>
              </div>
                  ...
                  <table style="width: 100%; border-collapse: collapse;">
                    <thead>
                      <tr style="background: #f5f5f5; border-bottom: 2px solid #e0e0e0;">
                        ...
                        <th style="padding: 15px 20px; text-align: left; font-size: 13px; font-weight: 600; color: #1a1a1a; text-transform: uppercase;">Cicilan</th>
                      ...
                      <?php if (empty($pembiayaan)): ?>
                        <tr>
                          <td colspan="9" style="padding: 40px; text-align: center; color: #808080;">
                            ...
                            <p style="margin: 0; font-size: 14px;">Belum ada pengajuan pembiayaan</p>
                            <p style="margin: 5px 0 0 0; font-size: 12px;">
                              <a href="index.php?controller=ajukanpembiayaan&action=create" style="color: #dc2626; font-weight: 500;">Ajukan pembiayaan sekarang</a>
                            </p>
                          </td>
                        </tr>
                      <?php else: ?>
                          ...
                          <tr style="border-bottom: 1px solid #f0f0f0; transition: background 0.2s ease;">
                            ...
                            <td style="padding: 15px 20px;">
                              <div style="font-weight: 600; color: #1a1a1a; font-size: 14px;">
                                Rp <?= number_format($row['cicilan_per_bulan'], 0, ',', '.') ?>
                              </div>
                              <div style="font-size: 11px; color: #808080; margin-top: 2px;">
                                /bulan
                              </div>
                            ...
                            <td style="padding: 15px 20px; text-align: center;">
                              <a href="index.php?controller=ajukanpembiayaan&action=view&id=<?= $row['id_pembiayaan'] ?>"
  ...
  <style>
    ...
    a[href*="ajukanpembiayaan&action=create"]:hover {
      background: rgba(220, 38, 38, 0.3) !important;
    }

    a[href*="ajukanpembiayaan&action=view"]:hover {
